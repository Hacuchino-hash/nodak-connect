...
class _ChannelsScreenState extends State<ChannelsScreen>
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: () async {
            await context.read<MeshCoreConnector>().getChannels(forceRefresh: true);
          },
          child: () {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            if (connector.isChannelMuted(channel.index))
              Padding(
            ...
            PopupMenuButton<String>(
              ...
              onSelected: (value) {
                if (value == 'mute') {
                  connector.setChannelMuted(
                    channel.index,
                    !connector.isChannelMuted(channel.index),
                  );
                }
              },
              itemBuilder: (context) => [
  ...
  void _handleQuickSwitch(int index, BuildContext context) {
    if (index == 2) return; // Already on Channels
    switch (index) {
      case 0:
        // Settings
        Navigator.push(
