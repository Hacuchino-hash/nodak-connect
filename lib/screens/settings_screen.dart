...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget _buildAboutCard(BuildContext context) {
    return Card(
      child: ListTile(
        ...
        subtitle: Text('Nodak Mesh Connect v$_appVersion'),
  ...
  void _showAbout(BuildContext context) {
    showAboutDialog(
      context: context,
      applicationName: 'Nodak Mesh Connect',
      applicationVersion: _appVersion,
      applicationLegalese: '2024 Nodak Mesh',
      children: [
        const SizedBox(height: 16),
        const Text(
          'A Flutter client for MeshCore LoRa mesh networking devices.',
        ),
      ],
    );
  }
